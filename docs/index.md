...
| 已有 Gitea 服务上的组织、用户、repo、issue、PR 全流程 | [Gitea End-to-End Quick Start](gitea-quickstart.md) |
| ChatTea 管理的 Gitea 服务运维、nginx/public 入口、安全边界 | [Gitea 服务运维](gitea-service-operations.md) |
| Gitea 仓库、用户、组织、团队可见性和 token scope | [Gitea 权限与可见性](gitea-permissions-and-visibility.md) |
